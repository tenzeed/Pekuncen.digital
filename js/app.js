            ...
            <form onsubmit="simpanIdentitasDanTema(event)">
              ...
              <div class="row g-3 mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" id="set-nama-sekretaris" class="form-control" value="${appSettings.nama_sekretaris || 'Sekretaris RW 08'}" placeholder="Contoh: Nama Sekretaris RT">
                </div>
                <div class="col-md-6">
                  ...
                  <input type="text" id="set-nama-rt-ketua" class="form-control" value="${appSettings.nama_rt_ketua || 'Ketua RW 08'}" placeholder="Contoh: Nama Ketua RT">
                </div>
              </div>
